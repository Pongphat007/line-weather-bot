...
| date | งานวิ่ง | โจทย์ | หมายเหตุ | ชื่อ |
|------|--------|------|---------|------|
| `YYYY-MM-DD` | ชื่องานแข่ง (ว่างได้) | โจทย์วิ่งของวันนั้น | หมายเหตุ (ว่างได้) | ชื่อคน |

ตัวอย่าง:

| date | งานวิ่ง | โจทย์ | หมายเหตุ | ชื่อ |
|------|--------|------|---------|------|
| 2026-09-16 | ATM | 5K easy @ 6:00 | วอร์มอัพดี ๆ | จ๋า |
| 2026-09-16 | ATM | 10K tempo | | นิว |
| 2026-09-17 | | Rest | | จ๋า |

- **แถวละหนึ่งคน** — คนละแถวแม้เป็นวันเดียวกัน
- แถวแรกต้องเป็น header ตามชื่อคอลัมน์ด้านบน (ลำดับคอลัมน์สลับได้ ระบบจับจากชื่อ header)
...
2. พิมพ์ `นิววิ่ง` → ตารางวันนี้ · พิมพ์ `ศุกร์นิววิ่ง` → ตารางวันศุกร์ในสัปดาห์นี้
3. พิมพ์ `หยุด` → ยกเลิกแจ้งเตือน

ลำดับข้อความตอบ: **ตารางวิ่งของ → งานวิ่ง → โจทย์ → หมายเหตุ**
...
| `<ชื่อ>วิ่ง` เช่น `นิววิ่ง` | ตารางวิ่งวันนี้ของคนนั้น |
| `<วัน><ชื่อ>วิ่ง` เช่น `ศุกร์นิววิ่ง` | ตารางวิ่งวันนั้นในสัปดาห์นี้ (จัน–อา) |
